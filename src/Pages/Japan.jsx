...
<h3 className='mt-24 p-4 m-4 text-black dark:text-white'>الرئيسية - الخريطة السياحية - اليابان</h3>
<div  id="Country" className='flex flex-col items-center gap-2 md:mr-14 w-fit'>
<div id="Japan" className='rounded-br-2xl bg-gradient-to-tr from-gray-800 to-[#af286cc6] w-fit m-3 p-2'>
...
<p className=' text-white text-4xl mt-3 mb-4 pb-3'>اليابان</p>
 ...
 <div className='flex justify-center space-x-3'>
  <img className='rounded-3xl md:w-[90px] lg:w-[150px]' src={Japan1} width={170} alt="" />
  <img className='rounded-3xl md:w-[90px] lg:w-[150px]' src={Japan2} width={170} alt="" />
...
<div className='flex flex-col  gap-4'>
    <p className='text-black dark:text-white text-2xl md:text-4xl text-center'>الخريطة السياحية - اليابان</p>
