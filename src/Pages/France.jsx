...
<h3 className='mt-24 p-4 m-4 text-black dark:text-white'>الرئيسية - الخريطة السياحية - فرنسا</h3>
...
<div id="France" className='rounded-br-2xl bg-gradient-to-tr from-gray-800 to-[#1d62b7c6] w-fit m-3 p-2'>
 <div  className='flex items-center gap-4'>
  <div id='FranceFlag'>
  <img  src={FranceFlag} width={150} />

  </div>

<div className='flex flex-col items-center gap-4'>
<p className=' text-[#ffffffc0] text-lg'>الخريطة السياحية</p>
<p className=' text-white text-4xl mt-3 mb-4 pb-3'>فرنسا</p>
 ...
 <div className='flex justify-center space-x-3'>
  <img className='rounded-3xl md:w-[90px] lg:w-[150px]' src={France1} width={170} alt="" />
  <img className='rounded-3xl md:w-[90px] lg:w-[150px]' src={France2} width={170} alt="" />
...
<div className='flex flex-col  gap-4'>
    <p className='text-black dark:text-white text-2xl md:text-4xl text-center'>الخريطة السياحية - فرنسا</p>
