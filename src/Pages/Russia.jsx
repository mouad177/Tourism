...
<h3 className='mt-24 p-4 m-4 text-black dark:text-white'>الرئيسية - عروض حصرية - عرض روسيا</h3>
<div  id="Country" className='flex flex-col items-center gap-2 md:mr-14 w-fit'>
<div id="Russia" className='rounded-br-2xl bg-gradient-to-tr from-gray-800 to-[#5d439ac6] w-fit m-3 p-2'>
 <div  className='flex items-center gap-4'>
  <div id='RussiaFlag'>
  <img  src={RussiaFlag} width={350} />

  </div>

<div className='flex flex-col items-center gap-4'>
<p className=' text-[#ffffffc0] text-lg'>عرض روسيا - كل المعلومات + الخريطة السياحية</p>
<p className=' text-white text-4xl mt-3'>روسيا</p>
 ...
 <div className='flex justify-center space-x-3'>
  <img className='rounded-3xl md:w-[80px] lg:w-[120px]' src={Russia1} width={120} alt="" />
...
<div className='flex flex-col  gap-4'>
    <p className='text-black dark:text-white text-2xl md:text-4xl text-center'>عرض روسيا - كل المعلومات + الخريطة السياحية</p>
