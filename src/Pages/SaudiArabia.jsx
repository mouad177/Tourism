...
import SaudiArabia1 from '/SallaProject/src/assets/img/SaudiArabia.jpg'
...
<h3 className='mt-24 p-4 m-4 text-black dark:text-white'>الرئيسية - كل المعلومات السياحية - المملكة العربية السعودية</h3>
<div  id="Country" className='flex flex-col items-center gap-2 md:mr-14 w-fit'>
<div id="SaudiArabia" className='rounded-br-2xl bg-gradient-to-tr from-gray-800 to-[#3b9462c6] w-fit m-3 p-2'>
 <div  className='flex items-center gap-4'>
  <div id='SaudiArabiaFlag'>
...
<p className=' text-white text-4xl mt-3 mb-4 pb-3'>السعــودية</p>
 ...
 <div className='flex justify-center space-x-3'>
  <img className='rounded-3xl' src={SaudiArabia1} width={90} alt="" />
  <img className='rounded-3xl' src={SaudiArabia2} width={90} alt="" />
...
<div className='flex flex-col  gap-4'>
    <p className='text-black dark:text-white text-2xl md:text-4xl text-center'>كل المعلومات السياحية - السعودية</p>
    <p className='text-[#33313190] dark:text-[#ffffffab] text-lg flex justify-end'>جميع معلومات السياحة في السعودية</p>
