...
<h3 className='mt-24 p-4 m-4 text-black dark:text-white'>الرئيسية - كل المعلومات السياحية - ايطاليا</h3>
<div  id="Country" className='flex flex-col items-center gap-2 md:mr-14 w-fit'>
<div id="Italy" className='rounded-br-2xl bg-gradient-to-tr from-gray-800 to-[#349170c6] w-fit m-3 p-2'>
...
<p className=' text-white text-4xl mt-3 mb-4 pb-3'>ايطاليا</p>
 ...
 <div className='flex justify-center space-x-3'>
  <img className='rounded-3xl md:w-[90px] lg:w-[170px]' src={Italy1} width={170} alt="" />
  <img className='rounded-3xl md:w-[90px] lg:w-[170px]' src={Italy2} width={170} alt="" />
...
<div className='flex flex-col  gap-4'>
    <p className='text-black dark:text-white text-2xl md:text-4xl text-center'>كل المعلومات السياحية - ايطاليا</p>
    <p className='text-[#33313190] dark:text-[#ffffffab] text-lg flex justify-end'>جميع معلومات السياحة في ايطاليا</p>
